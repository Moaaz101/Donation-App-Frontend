...
function AdDonorRequests() {
  ...
  const handleDownloadInformation = (id) => {
    ...
    link.href = `/src/pdfs/donor_information_${id}.pdf`; // Replace '/path/to/' with the actual path
  ...
  return (
    <div className="container-fluid p-0 m-0" style={{ width: '100vw', height: '100vh', color: 'white' }}> 
      ...
      <h3 className="display-3" style={{ fontWeight: 400 }}>Donor Requests</h3>
      <br></br><br></br>
...
export default AdDonorRequests;
